...
export function deleteTransaction(index) {
  ...
  switch (transaction.label) {
    case "dining":
      ...
      weekdata[0].data[0] -= transaction.amount;
      monthdata[1].data[0] -= transaction.amount;
      piedata[0].data[0] -= transaction.amount;
      break;
    case "entertainment":
      data[0].data[1] -= transaction.amount;
      weekdata[0].data[1] -= transaction.amount;
      monthdata[1].data[1] -= transaction.amount;
      piedata[0].data[1] -= transaction.amount;
      break;
    case "groceries":
      data[0].data[2] -= transaction.amount;
      weekdata[0].data[2] -= transaction.amount;
      monthdata[1].data[2] -= transaction.amount;
      piedata[0].data[2] -= transaction.amount;
      break;
    case "care":
      data[0].data[3] -= transaction.amount;
      weekdata[0].data[3] -= transaction.amount;
      monthdata[1].data[3] -= transaction.amount;
      piedata[0].data[3] -= transaction.amount;
      break;
    case "transportation":
      data[0].data[4] -= transaction.amount;
      weekdata[0].data[4] -= transaction.amount;
      monthdata[1].data[4] -= transaction.amount;
      piedata[0].data[4] -= transaction.amount;
      break;
    case "utilities":
      data[0].data[5] -= transaction.amount;
      weekdata[0].data[5] -= transaction.amount;
      monthdata[1].data[5] -= transaction.amount;
      piedata[0].data[5] -= transaction.amount;
      break;
    case "others":
      data[0].data[6] -= transaction.amount;
      weekdata[0].data[6] -= transaction.amount;
      monthdata[1].data[6] -= transaction.amount;
      piedata[0].data[6] -= transaction.amount;
      break;
    default:
      break;
  }
